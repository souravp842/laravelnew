...
@section('head_css')
    ...
    <link href="{{ asset('css/app.css') }}?no_cache={{ NINJA_VERSION }}" rel="stylesheet" type="text/css"/>
...
<nav class="navbar navbar-default navbar-fixed-top custom_header" role="navigation" >
    ...
    <div class="hide-phone menubar">
                <?php $menuarray = ['dashboard','clients','products','invoices','payments','recurring_invoices',
                    'credits','quotes','projects','tasks','expenses','vendors',];?>
                @foreach($menuarray as $option)
    ...
    <div class="collapse navbar-collapse" id="navbar-collapse-1">
      <div class="navbar-form navbar-right">
        ...
        <div class="btn-group user-dropdown">
            ...
            <a _ngcontent-c2="" aria-haspopup="true" class="nav-link dropdown-toggle" id="dropdown02" ngbdropdowntoggle="" aria-expanded="false">


                <span _ngcontent-c2="" class="profile-img">
            <img _ngcontent-c2="" src="{{ asset('/images/profile-img.png') }}">
          </span>
            </a>
          ...
          <button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">
            <div id="myAccountButton" class="ellipsis" style="max-width:{{ Utils::hasFeature(FEATURE_USERS) ? '130' : '100' }}px;">
                ...
                @else
                    ...
                    Profile
                @endif
                    <i _ngcontent-c2="" aria-hidden="true" class="fa fa-chevron-down" ></i>
            </div>
          </button>
...
<div id="wrapper" class="" style="padding-left: 0px;">
